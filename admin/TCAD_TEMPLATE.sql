...
--
-- Host: localhost
-- Generation Time: Apr 16, 2013 at 05:25 PM
...
CREATE TABLE `PROSPECT_LIST_NONE` (
  `prop_id` int(11) NOT NULL,
  `computed_date` datetime NOT NULL,
  `market_val` int(11) NOT NULL,
  `mean_val` int(11) NOT NULL,
...
CREATE TABLE `SPECIAL_IMP` (
  ...
  `det_size_adj` float DEFAULT NULL,
...
CREATE TABLE `SPECIAL_SALE_EX_CONF` (
  `prop_id` int(12) NOT NULL,
