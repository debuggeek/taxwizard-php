 ...
 * Current
 */
$fieldsofinterest = array($PROPID,$SITUS,NULL,$NEIGHB,NULL,$SALERATIO, $SALEDATE,
	$MARKETVALUE, $SALEPRICE,
	$ADJSALEPRICE, $SALETYPE,NULL,$LANDVALUEADJ, $STATECODE, $IMPROVEMENTCNT, $CLASSADJ, $GOODADJ, $COMPLETE, $LASIZEADJ,
	$LIVINGAREA, $ACTUALYEARBUILT, $MKTLEVELERDETAILADJ,
	$SEGMENTSADJSIMPLE, NULL,$NETADJ,NULL,$INDICATEDVAL,$TCADSCORE, NULL,$MEDIANVAL);

$fieldsofinteresteq = array($PROPID,$NEIGHB,NULL,
	$SITUS,$MARKETVALUE, NULL,
	$LANDVALUEADJ, $STATECODE, $IMPROVEMENTCNT, $CLASSADJ, $GOODADJ, $COMPLETE, NULL,
	$ACTUALYEARBUILT, $LASIZEADJ, $LIVINGAREA, $MKTLEVELERDETAILADJ, $SEGMENTSADJSIMPLE, NULL,
	$NETADJ,NULL,
	$INDICATEDVAL,NULL,
